...
class GFAlertVC: UIViewController {
    ...
    init(alertTitle: String? = nil, alertBody: String? = nil, alertButtonTitle: String? = nil) {
    ...
    private func configureActionButton(){
        ...
        actionButton.set(color: .systemPink, title: alertButtonTitle ?? "button error")
    ...
    private func configureBodyLabel(){
        ...
        bodyLabel.text = alertBody ?? "404 message error"
